...
// You can put any number of drops on a test strip at once and you can reuse
// a test strip as many times as you'd like
// (as long as the results are negative).
// However, you can only run tests once per day and
// it takes seven days to return a result.
// How would you figure out the poisoned bottle in as few days as possible?

// Follow Up:
// Write code to simulate your approach.

// Hints: #146, #163, #183, #197, #205, #221, #230, #241, #249